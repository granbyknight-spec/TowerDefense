...
class BattleScene extends Phaser.Scene {
  ...
  _createUnitSprite(unit) {
    ...
    // For 1x1 units: scale 64×64 SVG to fit inside the ring circle.
    // For 2x2 bosses: fill the 2-tile footprint at near-native size.
    let sprScale;
    if (sz === 2) {
    ...
    // Always use SVG sprites (generated by SpriteSheet.js) for map display.
