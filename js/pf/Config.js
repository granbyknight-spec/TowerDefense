...
const HERO_DEFS = {
  ...
  PUPPY_KNIGHT: {
    ...
    weapon:'sword', range:1, skills:['slash'],
    items:['herb'],
  ...
  LABRADOR_SCOUT: {
    id:'LABRADOR_SCOUT', name:'Lab Scout', emoji:'🦮',
    unitClass:'Scout', team:'player',
    baseStats:{ maxHp:18, atk:10, def:6, mov:7, agi:10, level:1, exp:0 },
    growth:{ hp:2, atk:2, def:1, agi:2 },
    weapon:'dagger', range:1, skills:['dash'],
    items:[],
    promotedData:{ name:'Lab Commander', emoji:'🦮', unitClass:'Commander',
      bonus:{ hp:6, atk:3, def:2, mov:2, agi:2 } },
    expReward:30, chapter:1,
  },
...
const SKILLS = {
  ...
  charge:   { name:'Charge',   type:'physical', power:1.5, range:1, mpCost:3, description:'Powerful charge' },
  guard:    { name:'Guard',    type:'buff',      mpCost:2,           description:'Raise DEF for 1 turn' },
  steal:    { name:'Steal',    type:'special',   range:1,            description:'Steal enemy item' },
  heal:     { name:'Heal',     type:'magic',     power:-1.2, range:1, mpCost:3, targetAlly:true, description:'Restore ally HP' },
