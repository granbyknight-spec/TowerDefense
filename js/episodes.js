    ...
    1: {
        ...
        scenes: [
            ...
            // === SCENE 7: The Rescue ===
            {
                ...
                characters: [],
                steps: [
                    { type: 'narration', text: 'The Cat King flees into the darkness... his army scatters in every direction, yowling in defeat. And there, in the depths of Cat Central...' },
                    ...
                    { type: 'narration', text: 'Two beautiful Golden Retrievers... tired, worn, but alive. As they see you approach... their tails begin to wag.' },
                    { type: 'enter', id: 'player', emoji: '{dogEmoji}', name: '{dogName}', x: 0.3, y: 0.7, scale: 1 },
                    { type: 'enter', id: 'frost', emoji: '🐺', name: 'Frost', x: 0.15, y: 0.65, scale: 0.9 },
                    { type: 'dialogue', speaker: 'Mama Goldie', emoji: '🦮', text: 'Oh my...! Are you from the Academy?! Please... please tell me; is our baby safe?!' },
                    { type: 'dialogue', speaker: '{dogName}', emoji: '{dogEmoji}', text: 'Your puppy is safe and warm at the Academy. They\'ve been waiting for you... so bravely, every single day.' },
                    { type: 'dialogue', speaker: 'Papa Goldie', emoji: '🦮', text: '*wipes tear with paw* Thank you... from the bottom of our hearts. We feared we\'d never see our little one again...' },
                    { type: 'dialogue', speaker: 'Papa Goldie', emoji: '🦮', text: 'Those cats made us fetch from dawn to dusk... They don\'t understand. We love fetching; it\'s in our blood. But only for those who love us back.' },
                    { type: 'narration', text: '📖 Retriever Fact: Golden Retrievers were bred to retrieve game with the gentlest of grips. Their legendary "soft mouth" can carry a raw egg without so much as a crack.' },
                    { type: 'shake', duration: 0.3, intensity: 3 },
                    { type: 'narration', text: 'And so, together... they begin the long journey home. Back to Puppy Academy.' },
                ]
            },
            ...
            // === SCENE 8: Reunion ===
            {
                ...
                steps: [
                    ...
                    { type: 'dialogue', speaker: 'Lost Puppy', emoji: '🐶', text: 'MAMA!! PAPA!! *runs and leaps into their arms*' },
                    { type: 'shake', duration: 0.3, intensity: 4 },
                    { type: 'move', id: 'puppy', x: 0.5, y: 0.48 },
                    { type: 'dialogue', speaker: 'Mama Goldie', emoji: '🦮', text: 'My baby...! Oh, we missed you so, so much! *nuzzle nuzzle* You\'re safe now... you\'re safe.' },
                    { type: 'dialogue', speaker: 'Papa Goldie', emoji: '🦮', text: 'You\'ve been so brave, little one... braver than you know. We are so incredibly proud of you.' },
                    ...
                    { type: 'dialogue', speaker: 'Old Rex', emoji: '🦮', text: '{dogName}... what you\'ve done today is nothing short of remarkable. Courage. Loyalty. Heart. You showed them all.' },
                    { type: 'dialogue', speaker: 'Old Rex', emoji: '🦮', text: 'Those are the qualities we treasure most at this Academy... not just in dogs, but in anyone who walks through our gates.' },
                    { type: 'dialogue', speaker: 'Mama Goldie', emoji: '🦮', text: 'If you\'ll have us... we\'d like to stay at the Academy. Our little one wants to grow up to be just like {dogName}!' },
                    { type: 'dialogue', speaker: 'Lost Puppy', emoji: '🐶', text: 'My name is Sunny! And someday... someday, I want to rescue other dogs, just like {dogName} rescued us!' },
                    ...
                    { type: 'dialogue', speaker: 'Frost', emoji: '🐺', text: 'Heh... that was quite the adventure. Count me in for the next one, {dogName}. Wouldn\'t miss it for the world.' },
                    { type: 'dialogue', speaker: 'Old Rex', emoji: '🦮', text: 'The Cat King escaped... which means this isn\'t over. He\'ll return, and when he does... we must be ready. But for now; let us celebrate.' },
                    { type: 'dialogue', speaker: 'Old Rex', emoji: '🦮', text: 'And {dogName}... remember what you learned today. Every dog has a story; a breed with a history, and a heart brimming with loyalty. Protect them all.' },
                    { type: 'narration', text: '📖 Final Fact: Over 360 recognized dog breeds exist across the world, each with its own extraordinary history and purpose. From the tiniest Chihuahua to the grandest Great Dane... every dog is special.' },
                    { type: 'dialogue', speaker: 'Sunny', emoji: '🐶', text: 'Thank you, {dogName}... you\'re the best friend a pup could ever have.' },
                    { type: 'narration', text: '🐾 Episode 1: "A Lost Pup" — COMPLETE! 🐾\n\nSunny is safe. The family is reunited.\nBut the Cat King is still out there...\nThe shadows grow longer, and a greater darkness stirs.\n\nTo be continued in Episode 2: "The Pack Grows"' },
