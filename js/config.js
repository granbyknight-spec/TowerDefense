...
const CONFIG = {
    ...
    TOWERS: {
        ...
        goldie: {
            ...
            isHealer: true,
            healAmount: 1,
            ability: { name: 'GOLDEN HEART', desc: 'Double heal rate 12s', cooldown: 60, duration: 12 }
        },
        dalmatian: {
            name: 'Dalmatian',
            emoji: '🏅',
            ...
            splash: 0,
            slow: 0,
            description: 'Fire DoT attacker',
            burnDamage: 4,
            burnDuration: 3,
            ability: { name: 'FIRE DRILL', desc: 'Double burn damage 10s', cooldown: 45, duration: 10 }
        },
        shiba: {
            name: 'Shiba Inu',
            emoji: '🐕‍🦺',
            ...
            splash: 0,
            slow: 0,
            description: 'Crit striker',
            critChance: 0.2,
            critMultiplier: 2.5,
            dodgeChance: 0.25,
            ability: { name: 'DOGE RUSH', desc: 'Double crit chance 8s', cooldown: 40, duration: 8 }
        }
    },
